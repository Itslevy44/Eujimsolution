...
// Import Navbar but don't render it in the Home component
// The parent/layout component will handle rendering the Navbar
        ...
        <div style={styles.heroContent}>
          ...
          <div style={styles.ctaButtons}>
            <button 
              ...
              onClick={handleFindTalent} // Updated to redirect to employerlogin
              onMouseOver={(e) => {
            ...
            <button 
              ...
              onClick={handleStudentLogin} // Redirects to studentlogin
              onMouseOver={(e) => {
