          ...
          <div>
            ...
            <div style={styles.contactItem}>
              ...
              <div>
                ...
                <p style={styles.sectionText}>Utawala, along Gesora Road</p>
                <p style={styles.sectionText}>Nairobi, Kenya 7034-00200</p>
              </div>
            </div>
            <div style={styles.contactItem}>
              <span style={styles.contactIcon}>
              ...
              <p style={styles.sectionText}>info@eujimsolutions.com</p>
            </div>
            <div style={styles.contactItem}>
              <span style={styles.contactIcon}>
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <p style={styles.sectionText}>+254 718 099959</p>
            </div>
          </div>
